...
{
    public class GetCommentByIdHandler : IRequestHandler<GetCommentByIdQuery, Domain.CommentClasses.Comment>
    {
        ...
        public async Task<Domain.CommentClasses.Comment> Handle(GetCommentByIdQuery request, CancellationToken cancellationToken)
        {
