...
namespace Blog.Services.Comments.Handler.Commands.RemoveComment
{
    public class RemoveCommentCommandHandler : IRequestHandler<RemoveCommentCommand, ResultStatus>
    {
        #region Constructor
        ...
        public RemoveCommentCommandHandler(ICommentRepositoryQuery read, ICommentRepositoryCommand write)
        {
            _read = read;
            _write = write;
