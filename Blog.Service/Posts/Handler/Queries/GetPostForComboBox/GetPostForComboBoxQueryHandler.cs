...
namespace Blog.Services.Posts.Handler.Queries.GetPostForComboBox
{
    public class GetPostForComboBoxQueryHandler:IRequestHandler<GetPostForComboBoxQuery,IEnumerable<PostForComboboxDTO>>
    {
        ...
        public GetPostForComboBoxQueryHandler(IPostRepositoryQuery read, IPostRepositoryCommand write)
        {
            _read = read;
            _write = write;
